<?php
// <$Id: AuthClassedEdit.php,v 1.7 2002/12/12 12:25:12 robhanssen Exp $>
...
class AuthClassedEdit
{
     ...
     function Enter($auth,$func)
     {
           ...
           <table>
                  ...
                  <tr>
                      ...
                      {
                      ?>                         
                        <td><input type="text" value="<?=$this->permission?>" name="authpermission"></td>
                      <?php
                      } else { 
                      ?>
                        <td><? echo $auth->getUserPerm(); ?><input type="hidden" value="<? echo $auth->getUserPerm(); ?>" name="authpermission"></td>
                      <? } ?>
                  </tr>
    ...
    function Display($auth)
    {
        ...
        $resultset = mysql_query($query);
        echo "<p>";
        if ($auth->isPermitted(ADMIN)) echo "<a href=\"$PHP_SELF?action=new\">Add new User</a>||";
        echo "<a href=\"$PHP_SELF\">View all Users</a>";
